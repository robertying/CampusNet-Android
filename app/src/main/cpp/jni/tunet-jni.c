...
JNIEXPORT void JNICALL Java_io_robertying_campusnet_helper_TunetHelper_tunetCleanup(JNIEnv *env,
                                                                                    jobject this) {
    tunet_cleanup();
}
...
static jobject enum_c_to_java(JNIEnv *env, res c_enum) {
    jclass response_type = (*env)->FindClass(env,
                                             "io/robertying/campusnet/helper/TunetHelper$ResponseType");
    jfieldID response_field_id = (*env)->GetStaticFieldID(env, response_type, res_string[c_enum],
                                                          "Lio/robertying/campusnet/helper/TunetHelper$ResponseType;");
    return (*env)->GetStaticObjectField(env, response_type, response_field_id);
}

JNIEXPORT jobject JNICALL Java_io_robertying_campusnet_helper_TunetHelper_netLogin(JNIEnv *env,
                                                                                   jobject this,
                                                                                   jstring username,
                                                                                   jstring password) {
...
JNIEXPORT jobject JNICALL Java_io_robertying_campusnet_helper_TunetHelper_auth4Login(JNIEnv *env,
                                                                                     jobject this,
                                                                                     jstring username,
                                                                                     jstring password) {
    const char *c_username = (*env)->GetStringUTFChars(env, username, NULL);
...
JNIEXPORT jobject JNICALL Java_io_robertying_campusnet_helper_TunetHelper_auth6Login(JNIEnv *env,
                                                                                     jobject this,
                                                                                     jstring username,
                                                                                     jstring password) {
    const char *c_username = (*env)->GetStringUTFChars(env, username, NULL);
...
JNIEXPORT jobject JNICALL Java_io_robertying_campusnet_helper_TunetHelper_netLogout(JNIEnv *env,
                                                                                    jobject this) {
    res response = net_logout();
    return enum_c_to_java(env, response);
}

JNIEXPORT jobject JNICALL Java_io_robertying_campusnet_helper_TunetHelper_auth4Logout(JNIEnv *env,
                                                                                      jobject this) {
    res response = auth4_logout();
    return enum_c_to_java(env, response);
}

JNIEXPORT jobject JNICALL Java_io_robertying_campusnet_helper_TunetHelper_auth6Logout(JNIEnv *env,
                                                                                      jobject this) {
    res response = auth6_logout();
    return enum_c_to_java(env, response);
}

JNIEXPORT jobject JNICALL Java_io_robertying_campusnet_helper_UseregHelper_useregLogin(JNIEnv *env,
                                                                                       jobject this,
                                                                                       jstring username,
                                                                                       jstring password) {
    const char *c_username = (*env)->GetStringUTFChars(env, username, NULL);
    ...
    res response = usereg_login(c_username, c_password);
    return enum_c_to_java(env, response);
}

JNIEXPORT jstring JNICALL Java_io_robertying_campusnet_helper_UseregHelper_getSessions(JNIEnv *env,
                                                                                       jobject this,
                                                                                       jstring username,
                                                                                       jstring password) {
    const char *c_username = (*env)->GetStringUTFChars(env, username, NULL);
...
JNIEXPORT void JNICALL Java_io_robertying_campusnet_helper_UseregHelper_dropSession(JNIEnv *env,
                                                                                    jobject this,
                                                                                    jstring username,
                                                                                    jstring password,
                                                                                    jstring sessionId) {
...
JNIEXPORT jfloat JNICALL Java_io_robertying_campusnet_helper_UseregHelper_getUsage(JNIEnv *env,
                                                                                   jobject this) {
